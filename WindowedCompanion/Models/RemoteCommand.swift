...
public enum MediaAction: String, Codable, Equatable, Sendable {
    case playPause
    case nextTrack
    case previousTrack
    case mute
...
public enum ClipboardAction: String, Codable, Equatable, Sendable {
    case copy
    case paste
}

public enum DesktopDirection: String, Codable, CaseIterable, Equatable, Sendable {
    case left
    case right
...
public enum WindowLayout: String, Codable, CaseIterable, Equatable, Sendable {
    case leftHalf
    case rightHalf
    case maximize
    case topLeftQuarter
...
public enum RemoteCommandType: Codable, Equatable, Sendable {
